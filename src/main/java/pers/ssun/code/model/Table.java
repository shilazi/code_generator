...
public class Table implements Serializable {
	...
	private String  javaObjectCamelNametoLowerCase;
	public Table() {
	...
	public String getJavaObjectCamelNametoLowerCase() {
		javaObjectCamelNametoLowerCase=javaObjectCamelName.substring(0, 1).toLowerCase()+javaObjectCamelName.substring(1, javaObjectCamelName.length());
		return javaObjectCamelNametoLowerCase;
	}
