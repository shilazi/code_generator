package pers.ssun.code.internal.config;
...
public class Configuration {
	...
	private static final String DAO_IMPL = "mybatis";
	...
	private String empty_before_files;

	public void init() throws IOException {
		// package prefix
		this.package_dao = this.package_prefix + ".mapper";
		this.package_dao_impl = this.package_dao + "." + DAO_IMPL;
		this.package_dao_impl_maps = this.package_dao_impl + ".maps";
		this.package_domain = this.package_prefix + ".model";
		...
		this.realpath_dao = relative_realpath + "";
		...
		this.realpath_service = relative_realpath + "";
	...
	public String getEmpty_before_files() {
		return empty_before_files;
	}

	public void setEmpty_before_files(String empty_before_files) {
		this.empty_before_files = empty_before_files;
	}
